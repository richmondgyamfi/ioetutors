...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="zmdi zmdi-file"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="zmdi zmdi-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="zmdi zmdi-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="zmdi zmdi-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="zmdi zmdi-zoom-in"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="zmdi zmdi-leak-remove"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="zmdi zmdi-file-plus text-warning"></i>',
                    indicatorSuccess: '<i class="zmdi zmdi-thumb-up text-success"></i>',
                    indicatorError: '<i class="zmdi zmdi-alert-circle text-danger"></i>',
                    indicatorLoading: '<i class="zmdi zmdi-hourglass text-muted"></i>',
                    indicatorPaused: '<i class="zmdi zmdi-pause text-primary"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="zmdi zmdi-triangle-down"></i>',
            next: '<i class="zmdi zmdi-triangle-up"></i>',
            toggleheader: '<i class="zmdi zmdi-border-vertical"></i>',
            fullscreen: '<i class="zmdi zmdi-fullscreen"></i>',
            borderless: '<i class="zmdi zmdi-fullscreen-exit"></i>',
            close: '<i class="zmdi zmdi-calendar-remove"></i>'
        },
        previewZoomButtonClasses: {
            prev: 'btn btn-navigate',
            next: 'btn btn-navigate',
            toggleheader: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
            fullscreen: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
            borderless: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round',
            close: 'btn btn-sm btn-kv btn-default btn-outline-primary btn-round'
        },
        previewTemplates: {},
        previewContentTemplates: {},
        ...
        removeIcon: '<i class="zmdi zmdi-delete"></i>',
        removeClass: 'btn btn-default btn-primary btn-round',
        cancelIcon: '<i class="zmdi zmdi-circle"></i>',
        cancelClass: 'btn btn-default btn-primary btn-round',
        pauseIcon: '<i class="zmdi zmdi-pause"></i>',
        pauseClass: 'btn btn-default btn-primary btn-round',
        uploadIcon: '<i class="zmdi zmdi-upload"></i>',
        uploadClass: 'btn btn-default btn-primary btn-round',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
        ...
        msgValidationErrorIcon: '<i class="zmdi zmdi-network-warning"></i> ',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgPaused: 'Paused',
        msgPlaceholder: 'Select {files} (.pdf/.jpg/.png/.jpeg)...',
        msgZoomModalHeading: 'Staff File Preview',
